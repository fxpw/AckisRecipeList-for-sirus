...
function addon:InitAlchemy()
	...
	-- Рецепт: Могущественный алхимический камень претендента -- 315386
	AddRecipe(315386, 435, 154305, Q.RARE, V.TBC, 435, 440, 445, 450) 
	self:AddRecipeFlags(315386, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(315386, 82190)
	
	-- Рецепт: Переменчивый алхимический камень претендента -- 315387
	AddRecipe(315387, 435, 154306, Q.RARE, V.TBC, 435, 440, 445, 450) 
	self:AddRecipeFlags(315387, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(315387, 82190)
	
	-- Рецепт: Несокрушимый алхимический камень претендента -- 315388
	AddRecipe(315388, 435, 154307, Q.RARE, V.TBC, 435, 440, 445, 450) 
	self:AddRecipeFlags(315388, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(315388, 82190)

	-- Настой сопротивления -- 270000
	AddRecipe(270000, 450, 270500, Q.EPIC, V.TBC, 450, 455, 460, 465)
	self:AddRecipeFlags(270000, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP)
	self:AddRecipeVendor(270000, 260039)

	-- Настой драконьего разума -- 270001
	AddRecipe(270001, 450, 270501, Q.EPIC, V.TBC, 450, 455, 460, 465)
	self:AddRecipeFlags(270001, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP)
	self:AddRecipeVendor(270001, 260039)

	-- Настой силы титана -- 270002
	AddRecipe(270002, 450, 270502, Q.EPIC, V.TBC, 450, 455, 460, 465)
	self:AddRecipeFlags(270002, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP)
	self:AddRecipeVendor(270002, 260039)

	-- Настой текущей воды -- 270003
	AddRecipe(270003, 450, 270503, Q.EPIC, V.TBC, 450, 455, 460, 465)
	self:AddRecipeFlags(270003, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP)
	self:AddRecipeVendor(270003, 260039)

	-- Настой стальной кожи -- 270004
	AddRecipe(270004, 450, 270504, Q.EPIC, V.TBC, 450, 455, 460, 465)
	self:AddRecipeFlags(270004, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP)
	self:AddRecipeVendor(270004, 260039)

	-- Настой крепости -- 270005
	AddRecipe(270005, 450, 270505, Q.EPIC, V.TBC, 450, 455, 460, 465)
	self:AddRecipeFlags(270005, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP)
	self:AddRecipeVendor(270005, 260039)

	-- Мглистый алмаз -- 300098
	AddRecipe(300098, 450, 52303, Q.EPIC, V.TBC, 450, 455, 460, 465)
	self:AddRecipeFlags(300098, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP)
	self:AddRecipeVendor(300098, 260039)	
	return num_recipes
end
