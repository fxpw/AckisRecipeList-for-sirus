...
function addon:InitCooking()
	...
	-- Филе дракоперой рыбы-ангела с приправами -- 300080
	AddRecipe(300080, 450, 290000, Q.RARE, V.TBC, 450, 455, 460, 465)
	self:AddRecipeFlags(300080, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP)
	self:AddRecipeVendor(300080, 31031)

	-- Сытное кушанье из мамонта с приправами -- 300081
	AddRecipe(300081, 450, 290001, Q.RARE, V.TBC, 450, 455, 460, 465)
	self:AddRecipeFlags(300081, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP)
	self:AddRecipeVendor(300081, 31031)

	-- Сочные сосиски из люторога с приправами -- 300082
	AddRecipe(300082, 450, 290002, Q.RARE, V.TBC, 450, 455, 460, 465)
	self:AddRecipeFlags(300082, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP)
	self:AddRecipeVendor(300082, 31031)

	-- Подкопченная дракоперая рыба-ангел с приправами -- 300083
	AddRecipe(300083, 450, 290003, Q.RARE, V.TBC, 450, 455, 460, 465)
	self:AddRecipeFlags(300083, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP)
	self:AddRecipeVendor(300083, 31031)

	-- Подкопченный лосось со специями -- 300084
	AddRecipe(300084, 450, 290004, Q.RARE, V.TBC, 450, 455, 460, 465)
	self:AddRecipeFlags(300084, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP)
	self:AddRecipeVendor(300084, 31031)

	-- Люторожий змеестейк с приправами -- 300085
	AddRecipe(300085, 450, 290005, Q.RARE, V.TBC, 450, 455, 460, 465)
	self:AddRecipeFlags(300085, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP)
	self:AddRecipeVendor(300085, 31031)

	-- Луциан особого приготовления с приправами -- 300086
	AddRecipe(300086, 450, 290006, Q.RARE, V.TBC, 450, 455, 460, 465)
	self:AddRecipeFlags(300086, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP)
	self:AddRecipeVendor(300086, 31031)

	-- Сочное мясо люторога со специями -- 300087
	AddRecipe(300087, 450, 290007, Q.RARE, V.TBC, 450, 455, 460, 465)
	self:AddRecipeFlags(300087, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP)
	self:AddRecipeVendor(300087, 31031)

	-- Черный студень с приправами -- 300088
	AddRecipe(300088, 450, 290008, Q.RARE, V.TBC, 450, 455, 460, 465)
	self:AddRecipeFlags(300088, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP)
	self:AddRecipeVendor(300088, 31031)

	-- Рыбный пир со специями -- 300089
	AddRecipe(300089, 450, 290009, Q.RARE, V.TBC, 450, 455, 460, 465)
	self:AddRecipeFlags(300089, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP)
	self:AddRecipeVendor(300089, 31031)

	-- Стейк из королевского ската со специями -- 300092
	AddRecipe(300092, 450, 290020, Q.RARE, V.TBC, 450, 455, 460, 465)
	self:AddRecipeFlags(300092, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP)
	self:AddRecipeVendor(300092, 31031)

	-- Даларанская похлебка из моллюсков -- 300095
	AddRecipe(300095, 450, 290021, Q.RARE, V.TBC, 450, 455, 460, 465)
	self:AddRecipeFlags(300095, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP)
	self:AddRecipeVendor(300095, 31031)

	-- Стейк из каракатицы с приправами -- 316195
	AddRecipe(316195, 450, 50485, Q.RARE, V.TBC, 450, 455, 460, 465)
	self:AddRecipeFlags(316195, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP)
	self:AddRecipeVendor(316195, 31031)

	-- Медуза с приправами -- 316196
	AddRecipe(316196, 450, 50486, Q.RARE, V.TBC, 450, 455, 460, 465)
	self:AddRecipeFlags(316196, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP)
	self:AddRecipeVendor(316196, 31031)

	-- Пряное лакомство из мамонта c приправами -- 316197
	AddRecipe(316197, 450, 50487, Q.RARE, V.TBC, 450, 455, 460, 465)
	self:AddRecipeFlags(316197, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP)
	self:AddRecipeVendor(316197, 31031)
