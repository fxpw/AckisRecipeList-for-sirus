...
function addon:InitEnchanting()
	...
	self:AddRecipeRepVendor(45765, FAC.SHATTEREDSUN, REP.HONORED, 260039)
	...
	self:AddRecipeRepVendor(46594, FAC.SHATTEREDSUN, REP.HONORED, 260039)
	...
	-- Чары для плаща - Скорость 3 -- 250000
	AddRecipe(250000, 450, 250000, Q.RARE, V.TBC, 450, 455, 460, 465)
	self:AddRecipeFlags(250000, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP)
	self:AddRecipeVendor(250000, 260039)

	-- Формула чар для плаща - могучая броня II -- 250001
	AddRecipe(250001, 450, 250001, Q.RARE, V.TBC, 450, 455, 460, 465) 
	self:AddRecipeFlags(250001, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(250001, 260039)
	
	-- Формула чар для плаща - ткань титанов II -- 250002
	AddRecipe(250002, 450, 250002, Q.RARE, V.TBC, 450, 455, 460, 465) 
	self:AddRecipeFlags(250002, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(250002, 260039)
	
	-- Формула чар для плаща - мудрость II -- 250003
	AddRecipe(250003, 450, 250003, Q.RARE, V.TBC, 450, 455, 460, 465) 
	self:AddRecipeFlags(250003, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(250003, 260039)
	
	-- Формула чар для плаща - пронзающие заклинания II -- 250004
	AddRecipe(250004, 450, 250004, Q.RARE, V.TBC, 450, 455, 460, 465) 
	self:AddRecipeFlags(250004, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(250004, 260039)
	
	-- Формула чар для плаща - скрытность II -- 250005
	AddRecipe(250005, 450, 250005, Q.RARE, V.TBC, 450, 455, 460, 465) 
	self:AddRecipeFlags(250005, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(250005, 260039)
	
	-- Формула чар для плаща - ловкость VI -- 250006
	AddRecipe(250006, 450, 250006, Q.RARE, V.TBC, 450, 455, 460, 465) 
	self:AddRecipeFlags(250006, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(250006, 260039)
	
	-- Формула чар для плаща - сопротивление V -- 250007
	AddRecipe(250007, 450, 250007, Q.RARE, V.TBC, 450, 455, 460, 465) 
	self:AddRecipeFlags(250007, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(250007, 260039)
	
	-- Формула чар для нагрудника - защита -III -- 250012
	AddRecipe(250012, 450, 250012, Q.RARE, V.TBC, 450, 455, 460, 465) 
	self:AddRecipeFlags(250012, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(250012, 260039)
	
	-- Формула чар для нагрудника - устойчивость III -- 250013
	AddRecipe(250013, 450, 250013, Q.RARE, V.TBC, 450, 455, 460, 465) 
	self:AddRecipeFlags(250013, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(250013, 260039)
	
	-- Формула чар для нагрудника - восстановление маны II -- 250014
	AddRecipe(250014, 450, 250014, Q.RARE, V.TBC, 450, 455, 460, 465) 
	self:AddRecipeFlags(250014, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(250014, 260039)
	
	-- Формула чар для нагрудника - все характеристики VIII -- 250015
	AddRecipe(250015, 450, 250015, Q.RARE, V.TBC, 450, 455, 460, 465) 
	self:AddRecipeFlags(250015, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(250015, 260039)
	
	-- Формула чар для обуви - стойкость III -- 250017
	AddRecipe(250017, 450, 250017, Q.RARE, V.TBC, 450, 455, 460, 465) 
	self:AddRecipeFlags(250017, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(250017, 260039)
	
	-- Формула чар для обуви - штурм III -- 250018
	AddRecipe(250018, 450, 250018, Q.RARE, V.TBC, 450, 455, 460, 465) 
	self:AddRecipeFlags(250018, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(250018, 260039)
	
	-- Формула чар для обуви - живучесть клыкарра II -- 250019
	AddRecipe(250019, 450, 250019, Q.RARE, V.TBC, 450, 455, 460, 465) 
	self:AddRecipeFlags(250019, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(250019, 260039)
	
	-- Формула чар для обуви - ледопроходец II -- 250020
	AddRecipe(250020, 450, 250020, Q.RARE, V.TBC, 450, 455, 460, 465) 
	self:AddRecipeFlags(250020, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(250020, 260039)
	
	-- Формула чар для обуви - ловкость VI -- 250021
	AddRecipe(250021, 450, 250021, Q.RARE, V.TBC, 450, 455, 460, 465) 
	self:AddRecipeFlags(250021, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(250021, 260039)
	
	-- Формула чар для обуви - дух IV -- 250022
	AddRecipe(250022, 450, 250022, Q.RARE, V.TBC, 450, 455, 460, 465) 
	self:AddRecipeFlags(250022, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(250022, 260039)
	
	-- Формула чар для перчаток - ловкость V -- 250024
	AddRecipe(250024, 450, 250024, Q.RARE, V.TBC, 450, 455, 460, 465) 
	self:AddRecipeFlags(250024, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(250024, 260039)
	
	-- Формула чар для перчаток - мастерство II -- 250025
	AddRecipe(250025, 450, 250025, Q.RARE, V.TBC, 450, 455, 460, 465) 
	self:AddRecipeFlags(250025, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(250025, 260039)
	
	-- Формула чар для перчаток - оружейник II -- 250026
	AddRecipe(250026, 450, 250026, Q.RARE, V.TBC, 450, 455, 460, 465) 
	self:AddRecipeFlags(250026, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(250026, 260039)
	
	-- Формула чар для перчаток - сила заклинаний III -- 250027
	AddRecipe(250027, 450, 250027, Q.RARE, V.TBC, 450, 455, 460, 465) 
	self:AddRecipeFlags(250027, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(250027, 260039)
	
	-- Формула чар для перчаток - крушитель II -- 250028
	AddRecipe(250028, 450, 250028, Q.RARE, V.TBC, 450, 455, 460, 465) 
	self:AddRecipeFlags(250028, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(250028, 260039)
	
	-- Формула чар для щита - блок III -- 250030
	AddRecipe(250030, 450, 250030, Q.RARE, V.TBC, 450, 455, 460, 465) 
	self:AddRecipeFlags(250030, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(250030, 260039)
	
	-- Формула чар для щита - выносливость VI -- 250031
	AddRecipe(250031, 450, 250031, Q.RARE, V.TBC, 450, 455, 460, 465) 
	self:AddRecipeFlags(250031, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(250031, 260039)
	
	-- Формула чар для щита - устойчивость II -- 250032
	AddRecipe(250032, 450, 250032, Q.RARE, V.TBC, 450, 455, 460, 465) 
	self:AddRecipeFlags(250032, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(250032, 260039)
	
	-- Формула чар для щита - защита --- 250033
	AddRecipe(250033, 450, 250033, Q.RARE, V.TBC, 450, 455, 460, 465) 
	self:AddRecipeFlags(250033, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(250033, 260039)
	
	-- Формула чар для щита - интеллект III -- 250034
	AddRecipe(250034, 450, 250034, Q.RARE, V.TBC, 450, 455, 460, 465) 
	self:AddRecipeFlags(250034, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(250034, 260039)
	
	-- Формула чар для щита - сопротивление I -- 250035
	AddRecipe(250035, 450, 250035, Q.RARE, V.TBC, 450, 455, 460, 465) 
	self:AddRecipeFlags(250035, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(250035, 260039)
	
	-- Формула чар для наручей - все характеристики III -- 250037
	AddRecipe(250037, 450, 250037, Q.RARE, V.TBC, 450, 455, 460, 465) 
	self:AddRecipeFlags(250037, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(250037, 260039)
	
	-- Формула чар для наручей - мастерство II -- 250038
	AddRecipe(250038, 450, 250038, Q.RARE, V.TBC, 450, 455, 460, 465) 
	self:AddRecipeFlags(250038, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(250038, 260039)
	
	-- Формула чар для наручей - дух VII -- 250039
	AddRecipe(250039, 450, 250039, Q.RARE, V.TBC, 450, 455, 460, 465) 
	self:AddRecipeFlags(250039, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(250039, 260039)
	
	-- Формула чар для наручей - штурм III -- 250040
	AddRecipe(250040, 450, 250040, Q.RARE, V.TBC, 450, 455, 460, 465) 
	self:AddRecipeFlags(250040, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(250040, 260039)
	
	-- Формула чар для наручей - сила заклинаний IV -- 250041
	AddRecipe(250041, 450, 250041, Q.RARE, V.TBC, 450, 455, 460, 465) 
	self:AddRecipeFlags(250041, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(250041, 260039)
	
	-- Формула чар для наручей - выносливость VII -- 250042
	AddRecipe(250042, 450, 250042, Q.RARE, V.TBC, 450, 455, 460, 465) 
	self:AddRecipeFlags(250042, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(250042, 260039)
	
	-- Формула чар для оружия - ловкость IV -- 250045
	AddRecipe(250045, 450, 250045, Q.RARE, V.TBC, 450, 455, 460, 465) 
	self:AddRecipeFlags(250045, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(250045, 260039)
	
	-- Формула чар для оружия - дух III -- 250046
	AddRecipe(250046, 450, 250046, Q.RARE, V.TBC, 450, 455, 460, 465) 
	self:AddRecipeFlags(250046, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(250046, 260039)
	
	-- Формула чар для оружия - могущество IV -- 250047
	AddRecipe(250047, 450, 250047, Q.RARE, V.TBC, 450, 455, 460, 465) 
	self:AddRecipeFlags(250047, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(250047, 260039)
	
	-- Формула чар для оружия - сила заклинаний IV -- 250048
	AddRecipe(250048, 450, 250048, Q.RARE, V.TBC, 450, 455, 460, 465) 
	self:AddRecipeFlags(250048, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(250048, 260039)
	
	-- Формула чар для оружия - меткость II -- 250050
	AddRecipe(250050, 450, 250050, Q.RARE, V.TBC, 450, 455, 460, 465) 
	self:AddRecipeFlags(250050, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(250050, 260039)
	
	-- Формула чар для двуручного оружия - резня II -- 250053
	AddRecipe(250053, 450, 250053, Q.RARE, V.TBC, 450, 455, 460, 465) 
	self:AddRecipeFlags(250053, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(250053, 260039)
	
	-- Формула чар для посоха - сила заклинаний III -- 250054
	AddRecipe(250054, 450, 250054, Q.RARE, V.TBC, 450, 455, 460, 465) 
	self:AddRecipeFlags(250054, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(250054, 260039)
	
	-- Формула - Иллюзорное масло маны -- 315384
	AddRecipe(315384, 435, 154303, Q.RARE, V.TBC, 435, 440, 445, 450) 
	self:AddRecipeFlags(315384, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(315384, 82190)
	
	-- Формула - Иллюзорное волшебное масло -- 315385
	AddRecipe(315385, 435, 154304, Q.RARE, V.TBC, 435, 440, 445, 450) 
	self:AddRecipeFlags(315385, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(315385, 82190)
