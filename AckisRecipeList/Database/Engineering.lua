...
function addon:InitEngineering()
	...
	-- Схема - Набор для снятия ограничений -- 302211
	AddRecipe(302211, 450, 302211, Q.RARE, V.TBC, 450, 455, 460, 465) 
	self:AddRecipeFlags(302211, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(302211, 260039)
		
	-- Схема - Угрозодетектор R19 -- 302213
	AddRecipe(302213, 450, 302213, Q.RARE, V.TBC, 450, 455, 460, 465) 
	self:AddRecipeFlags(302213, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(302213, 260039)
		
	-- Схема - Трицикл -- 302215
	AddRecipe(302215, 450, 302215, Q.RARE, V.TBC, 450, 455, 460, 465) 
	self:AddRecipeFlags(302215, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(302215, 260039)
		
	-- Схема - Турботрицикл -- 302216
	AddRecipe(302216, 450, 302216, Q.RARE, V.TBC, 450, 455, 460, 465) 
	self:AddRecipeFlags(302216, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(302216, 260039)
		
	-- Схема - Механическая пелерина претендента -- 315377
	AddRecipe(315377, 435, 315377, Q.RARE, V.TBC, 435, 440, 445, 450) 
	self:AddRecipeFlags(315377, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(315377, 82190)
	
	-- Схема - Механический плащ претендента -- 315378
	AddRecipe(315378, 435, 315378, Q.RARE, V.TBC, 435, 440, 445, 450) 
