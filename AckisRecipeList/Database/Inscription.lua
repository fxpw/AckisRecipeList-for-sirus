...
function addon:InitInscription()
	...
	-- Великое начертание - Журавлиного крыла -- 302093
	AddRecipe(302093, 450, 302093, Q.RARE, V.TBC, 450, 455, 460, 465) 
	self:AddRecipeFlags(302093, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(302093, 260039)

	-- Великое начертание - Клыка тигра -- 302094
	AddRecipe(302094, 450, 302094, Q.RARE, V.TBC, 450, 455, 460, 465) 
	self:AddRecipeFlags(302094, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(302094, 260039)

	-- Великое начертание - Коготя тигра -- 302095
	AddRecipe(302095, 450, 302095, Q.RARE, V.TBC, 450, 455, 460, 465) 
	self:AddRecipeFlags(302095, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(302095, 260039)

	-- Великое начертание - Рога быка -- 302096
	AddRecipe(302096, 450, 302096, Q.RARE, V.TBC, 450, 455, 460, 465) 
	self:AddRecipeFlags(302096, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(302096, 260039)
	
	-- Технология - Свиток ловкости IX -- 315379
	AddRecipe(315379, 435, 315379, Q.RARE, V.TBC, 435, 440, 445, 450) 
	self:AddRecipeFlags(315379, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(315379, 82190)
		
	-- Технология - Свиток духа IX -- 315380
	AddRecipe(315380, 435, 315380, Q.RARE, V.TBC, 435, 440, 445, 450) 
	self:AddRecipeFlags(315380, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(315380, 82190)
			
	-- Технология - Свиток силы IX -- 315381
	AddRecipe(315381, 435, 315381, Q.RARE, V.TBC, 435, 440, 445, 450) 
	self:AddRecipeFlags(315381, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(315381, 82190)
			
	-- Технология - Свиток интеллекта IX -- 315382
	AddRecipe(315382, 435, 315382, Q.RARE, V.TBC, 435, 440, 445, 450) 
	self:AddRecipeFlags(315382, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(315382, 82190)
			
	-- Технология - Свиток выносливости IX -- 315383
	AddRecipe(315383, 435, 315383, Q.RARE, V.TBC, 435, 440, 445, 450) 
	self:AddRecipeFlags(315383, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(315383, 82190)
