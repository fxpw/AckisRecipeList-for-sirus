...
function addon:InitTailoring()
	...
	-- Прочная сверкающая чародейская нить -- 280003
	AddRecipe(280003, 450, 280003, Q.RARE, V.TBC, 450, 455, 460, 465) 
	self:AddRecipeFlags(280003, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(280003, 260039)
	
	-- Прочная сапфировая чародейская нить -- 280004
	AddRecipe(280004, 450, 280004, Q.RARE, V.TBC, 450, 455, 460, 465) 
	self:AddRecipeFlags(280004, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(280004, 260039)
	
	-- Выкройка - Клобук ледяной ярости претендента -- 315365
	AddRecipe(315365, 435, 315365, Q.RARE, V.TBC, 435, 440, 445, 450) 
	self:AddRecipeFlags(315365, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(315365, 82190)
	
	-- Выкройка - Поножи ледяной ярости претендента -- 315366
	AddRecipe(315366, 435, 315366, Q.RARE, V.TBC, 435, 440, 445, 450) 
	self:AddRecipeFlags(315366, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(315366, 82190)
	
	-- Выкройка - Одеяние ледяной ярости претендента -- 315367
	AddRecipe(315367, 435, 315367, Q.RARE, V.TBC, 435, 440, 445, 450) 
	self:AddRecipeFlags(315367, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(315367, 82190)
	
	-- Выкройка - Перчатки ледяной ярости претендента -- 315368
	AddRecipe(315368, 435, 315368, Q.RARE, V.TBC, 435, 440, 445, 450) 
	self:AddRecipeFlags(315368, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(315368, 82190)
	
	-- Выкройка - Сапоги ледяной ярости претендента -- 315369
	AddRecipe(315369, 435, 315369, Q.RARE, V.TBC, 435, 440, 445, 450) 
	self:AddRecipeFlags(315369, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(315369, 82190)
	
	-- Выкройка - Наплечники ледяной ярости претендента -- 315370
	AddRecipe(315370, 435, 315370, Q.RARE, V.TBC, 435, 440, 445, 450) 
	self:AddRecipeFlags(315370, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(315370, 82190)
	
	-- Выкройка - Наручи ледяной ярости претендента -- 315371
	AddRecipe(315371, 435, 315371, Q.RARE, V.TBC, 435, 440, 445, 450) 
	self:AddRecipeFlags(315371, F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP) 
	self:AddRecipeVendor(315371, 82190)
	
	-- Выкройка - Пояс ледяной ярости претендента -- 315372
