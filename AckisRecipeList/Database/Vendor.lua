...
function addon:InitVendor(DB)
	...
	AddVendor(9499,		L["Plugger Spazzring"],		BZ["Blackrock Depths"],		   0,	 0, NEUTRAL)
	...
	AddVendor(15471,	L["Lieutenant General Andorov"],	BZ["Ruins of Ahn'Qiraj"],	   0,	 0, NEUTRAL)
	...
	AddVendor(82190,	L["Kargorat"],				BZ["TolGarod"],			24.35, 48.02, NEUTRAL)
	AddVendor(260039,	L["Luigi"],				BZ["Isle of Quel'Danas"],	47.1, 30.0, NEUTRAL)
	AddVendor(500126,	L["Relatiy"],				BZ["Dalaran"],			40.3, 35.5, NEUTRAL)
end
